...
public class LineGraphSeriesCustom<E extends DataPointInterface> extends BaseSeriesCustom<E> {
     ...
     */
    public LineGraphSeriesCustom(E[] data) {
        super(data);
        init();
    }
