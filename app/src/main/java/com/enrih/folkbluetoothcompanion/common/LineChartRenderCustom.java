...
public class LineChartRenderCustom extends LineRadarRenderer {
    ...
    public LineChartRenderCustom(LineDataProvider chart, ChartAnimator animator,
        ...
        mXBounds.set(mChart, dataSet);
            ...
            if (e1 != null) {
                ...
                if (j > 0) {
                    ...
                    final int size = Math.max((entryCount + 1) * pointsPerEntryPair, pointsPerEntryPair) * 2;
        ...
        if (isDrawingValuesAllowed(mChart)) {
            ...
            for (int i = 0; i < dataSets.size(); i++) {
                ...
                float[] positions = trans.generateTransformedValuesLine(dataSet, mAnimator.getPhaseX(), mAnimator
                        .getPhaseY(), 0, dataSet.getEntryCount()-1);
     ...
     */
    private HashMap<IDataSet, DataSetImageCacheCustom> mImageCaches = new HashMap<>();
    ...
    protected void drawCircles(Canvas c) {
        ...
        for (int i = 0; i < dataSets.size(); i++) {
            ...
            LineChartRenderCustom.DataSetImageCacheCustom imageCache;

            if (mImageCaches.containsKey(dataSet)) {
                imageCache = mImageCaches.get(dataSet);
            } else {
                imageCache = new LineChartRenderCustom.DataSetImageCacheCustom();
            ...
            int boundsRangeCount = dataSet.getEntryCount();

            for (int j = 0; j < boundsRangeCount; j++) {
    ...
    private class DataSetImageCacheCustom {
